...
# Load data
mdf = pd.read_csv(r'C:\Users\Rathod Rahul\Downloads\life-expectancy-dashboard-main\life-expectancy-dashboard-main\dataset\malaysia_life_expectancy.csv')
  # malaysian dataset
wdf = pd.read_csv(r'C:\Users\Rathod Rahul\Downloads\life-expectancy-dashboard-main\life-expectancy-dashboard-main\dataset\worldwide_life_expectancy.csv')
  # world dataset
